...
public class Vegetable extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    static String vstr;
    ListView lv;
    TextView tv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] values=new String[]{getResources().getString(R.string.broccoli),getResources().getString(R.string.cabbage),getResources().getString(R.string.carrot),
                getResources().getString(R.string.cauliflower),getResources().getString(R.string.cucumber),getResources().getString(R.string.garlic),
                getResources().getString(R.string.lettuce),getResources().getString(R.string.mushroom),getResources().getString(R.string.pepper),getResources().getString(R.string.tomato)};
        Class_Vegetable list=new Class_Vegetable(this,values);
        lst.setAdapter(list);
        lst.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                //Toast.makeText(Family.this, values[i], Toast.LENGTH_LONG).show();
                if (values[i].equals(getResources().getString(R.string.broccoli)))
                    vstr = "broccoli";
                else if (values[i].equals(getResources().getString(R.string.cabbage)))
                    vstr = "cabbage";
                else if (values[i].equals(getResources().getString(R.string.carrot)))
                    vstr = "carrot";
                else if (values[i].equals(getResources().getString(R.string.cauliflower)))
                    vstr = "cauliflower";
                else if (values[i].equals(getResources().getString(R.string.cucumber)))
                    vstr = "cucumber";
                else if (values[i].equals(getResources().getString(R.string.garlic)))
                    vstr = "garlic";
                else if (values[i].equals(getResources().getString(R.string.lettuce)))
                    vstr = "lettuce";
                else if (values[i].equals(getResources().getString(R.string.mushroom)))
                    vstr = "mushroom";
                else if (values[i].equals(getResources().getString(R.string.pepper)))
                    vstr = "pepper";
                else if (values[i].equals(getResources().getString(R.string.tomato)))
                    vstr = "tomato";
