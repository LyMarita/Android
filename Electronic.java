...
public class Electronic extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
...
ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] values=new String[]{getResources().getString(R.string.camcorder),
                getResources().getString(R.string.camera),getResources().getString(R.string.computer),
                getResources().getString(R.string.laptop),getResources().getString(R.string.mobile_phone),
                getResources().getString(R.string.printer),getResources().getString(R.string.smart_watch),
                getResources().getString(R.string.speaker),getResources().getString(R.string.tablet),getResources().getString(R.string.television),
                getResources().getString(R.string.telephone)};
        Class_Electronic listFamily=new Class_Electronic(this,values);
        lst.setAdapter(listFamily);
        lst.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                //Toast.makeText(Electronic.this, values[i], Toast.LENGTH_LONG).show();
                if (values[i].equals(getResources().getString(R.string.camcorder)))
                    stritem = "camcorder";
                if (values[i].equals(getResources().getString(R.string.camera)))
                    stritem = "camera";
                if (values[i].equals(getResources().getString(R.string.computer)))
                    stritem = "computer";
                if (values[i].equals(getResources().getString(R.string.laptop)))
                    stritem = "laptop";
                if (values[i].equals(getResources().getString(R.string.mobile_phone)))
                    stritem = "mobile_phone";
                if (values[i].equals(getResources().getString(R.string.printer)))
                    stritem = "printer";
                if (values[i].equals(getResources().getString(R.string.smart_watch)))
                    stritem = "smart_watch";
                if (values[i].equals(getResources().getString(R.string.speaker)))
                    stritem = "speaker";
                if (values[i].equals(getResources().getString(R.string.tablet)))
                    stritem = "tablet";
                if (values[i].equals(getResources().getString(R.string.television)))
                    stritem = "television";
                if (values[i].equals(getResources().getString(R.string.telephone)))
                    stritem = "telephone";
