...
public class Drink extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    static String dstr;
    ListView lv;
    TextView tv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] values=new String[]{getResources().getString(R.string.coca_cola),getResources().getString(R.string.coffee),getResources().getString(R.string.milk),
                getResources().getString(R.string.orange_juice),getResources().getString(R.string.soda),getResources().getString(R.string.pure_water)};
        Class_Drink list=new Class_Drink(this,values);
        lst.setAdapter(list);
        lst.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                //Toast.makeText(Family.this, values[i], Toast.LENGTH_LONG).show();
                if (values[i].equals(getResources().getString(R.string.coca_cola)))
                    dstr = "coca_cola";
                else if (values[i].equals(getResources().getString(R.string.coffee)))
                    dstr = "coffee";
                else if (values[i].equals(getResources().getString(R.string.milk)))
                    dstr = "milk";
                else if (values[i].equals(getResources().getString(R.string.orange_juice)))
                    dstr = "orange_juice";
                else if (values[i].equals(getResources().getString(R.string.soda)))
                    dstr = "soda";
                else if (values[i].equals(getResources().getString(R.string.pure_water)))
                    dstr = "pure_water";
