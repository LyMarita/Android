...
public class Family extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] values=new String[]{getResources().getString(R.string.aunt),getResources().getString(R.string.daughter),getResources().getString(R.string.father),
                getResources().getString(R.string.grandmother),getResources().getString(R.string.husband),getResources().getString(R.string.mother),
                getResources().getString(R.string.sister),getResources().getString(R.string.son),getResources().getString(R.string.wife)};
        Class_Family list=new Class_Family(this,values);
        lst.setAdapter(list);
        lst.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                //Toast.makeText(Family.this, values[i], Toast.LENGTH_LONG).show();
                if (values[i].equals(getResources().getString(R.string.aunt)))
                    fstr = "aunt";
                else if (values[i].equals(getResources().getString(R.string.daughter)))
                    fstr = "daughter";
                else if (values[i].equals(getResources().getString(R.string.father)))
                    fstr = "father";
                else if (values[i].equals(getResources().getString(R.string.grandmother)))
                    fstr = "grandmother";
                else if (values[i].equals(getResources().getString(R.string.husband)))
                    fstr = "husband";
                else if (values[i].equals(getResources().getString(R.string.mother)))
                    fstr = "mother";
                else if (values[i].equals(getResources().getString(R.string.sister)))
                    fstr = "sister";
                else if (values[i].equals(getResources().getString(R.string.son)))
                    fstr = "son";
                else if (values[i].equals(getResources().getString(R.string.wife)))
                    fstr = "wife";
