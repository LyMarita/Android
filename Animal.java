...
public class Animal extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    static String astr;
    ListView lv;
    TextView tv;
    TextView testText="";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        final String[] values=new String[]{getResources().getString(R.string.cat),getResources().getString(R.string.chicken),getResources().getString(R.string.cow),
                getResources().getString(R.string.crocodile),getResources().getString(R.string.dog),getResources().getString(R.string.duck),getResources().getString(R.string.fish)
                ,getResources().getString(R.string.snake),
                getResources().getString(R.string.tiger),getResources().getString(R.string.zebra)};
        Class_Animal list=new Class_Animal(this,values);
        lst.setAdapter(list);
        lst.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                //Toast.makeText(Family.this, values[i], Toast.LENGTH_LONG).show();
                if (values[i].equals(getResources().getString(R.string.cat)))
                    astr = "cat";
                else if (values[i].equals(getResources().getString(R.string.chicken)))
                    astr = "chicken";
                else if (values[i].equals(getResources().getString(R.string.cow)))
                    astr = "cow";
                else if (values[i].equals(getResources().getString(R.string.crocodile)))
                    astr = "crocodile";
                else if (values[i].equals(getResources().getString(R.string.dog)))
                    astr = "dog";
                else if (values[i].equals(getResources().getString(R.string.duck)))
                    astr = "duck";
                else if (values[i].equals(getResources().getString(R.string.fish)))
                    astr = "fish";
                else if (values[i].equals(getResources().getString(R.string.snake)))
                    astr = "snake";
                else if (values[i].equals(getResources().getString(R.string.tiger)))
                    astr = "tiger";
                else if (values[i].equals(getResources().getString(R.string.zebra)))
                    astr = "zebra";
