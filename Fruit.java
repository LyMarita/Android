...
public class Fruit extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        final String[] values=new String[]{getResources().getString(R.string.apple),getResources().getString(R.string.banana),
                getResources().getString(R.string.durian),getResources().getString(R.string.grape),getResources().getString(R.string.guava),
                getResources().getString(R.string.jackfruit),getResources().getString(R.string.jujube),getResources().getString(R.string.kiwi),
                getResources().getString(R.string.lychee),getResources().getString(R.string.mango),getResources().getString(R.string.mangosteen),
                getResources().getString(R.string.orange),getResources().getString(R.string.papaya),getResources().getString(R.string.persimmon),
                getResources().getString(R.string.pineapple),getResources().getString(R.string.pomegranate),getResources().getString(R.string.rambutan),
                getResources().getString(R.string.sapodilla),getResources().getString(R.string.strawberry),getResources().getString(R.string.sweetsop)
                ,getResources().getString(R.string.watermelon)};
        Class_Fruit listFamily=new Class_Fruit(this,values);
        lst.setAdapter(listFamily);
        lst.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                //Toast.makeText(Electronic.this, values[i], Toast.LENGTH_LONG).show();
                if (values[i].equals(getResources().getString(R.string.apple)))
                    st = "apple";
                if (values[i].equals(getResources().getString(R.string.banana)))
                    st = "banana";
                if (values[i].equals(getResources().getString(R.string.durian)))
                    st = "durian";
                if (values[i].equals(getResources().getString(R.string.grape)))
                    st = "grape";
                if (values[i].equals(getResources().getString(R.string.guava)))
                    st = "guava";
                if (values[i].equals(getResources().getString(R.string.jackfruit)))
                    st = "jackfruit";
                if (values[i].equals(getResources().getString(R.string.jujube)))
                    st = "jujube";
                if (values[i].equals(getResources().getString(R.string.kiwi)))
                    st = "kiwi";
                if (values[i].equals(getResources().getString(R.string.lychee)))
                    st = "lychee";
                if (values[i].equals(getResources().getString(R.string.mango)))
                    st = "mango";
                if (values[i].equals(getResources().getString(R.string.mangosteen)))
                    st = "mangosteen";
                if (values[i].equals(getResources().getString(R.string.orange)))
                    st = "orange";
                if (values[i].equals(getResources().getString(R.string.papaya)))
                    st = "papaya";
                if (values[i].equals(getResources().getString(R.string.persimmon)))
                    st = "persimmon";
                if (values[i].equals(getResources().getString(R.string.pineapple)))
                    st = "pineapple";
                if (values[i].equals(getResources().getString(R.string.pomegranate)))
                    st = "pomegranate";
                if (values[i].equals(getResources().getString(R.string.rambutan)))
                    st = "rambutan";
                if (values[i].equals(getResources().getString(R.string.sapodilla)))
                    st = "sapodilla";
                if (values[i].equals(getResources().getString(R.string.strawberry)))
                    st = "strawberry";
                if (values[i].equals(getResources().getString(R.string.sweetsop)))
                    st = "sweetsop";
                if (values[i].equals(getResources().getString(R.string.watermelon)))
                    st = "watermelon";
                Intent A_Img = new Intent(getApplication(), Image.class);
                startActivity(A_Img);
            }
        });
