...
public class Occupation extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    public static String stOcc;
    ListView lv;
    TextView tv;
    LinearLayout linearLayout;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState); setContentView(R.layout.activity_navigation__drawer);
        ListView lst=(ListView)findViewById(R.id.MyListView);
        final String[] values=new String[]{
                getResources().getString(R.string.businessman),
                getResources().getString(R.string.chef),
                getResources().getString(R.string.cleaner),
                getResources().getString(R.string.doctor),
                getResources().getString(R.string.farmer),
                getResources().getString(R.string.lawyer),
                getResources().getString(R.string.painter),
                getResources().getString(R.string.programmer),
                getResources().getString(R.string.scientist),
                getResources().getString(R.string.soldier),
                getResources().getString(R.string.vet)};
        Class_Occupation listFamily=new Class_Occupation(this,values);
        lst.setAdapter(listFamily);
        lst.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                //Toast.makeText(Electronic.this, values[i], Toast.LENGTH_LONG).show();
                if (values[i].equals(getResources().getString(R.string.businessman)))
                    stOcc = "businessman";
                if (values[i].equals(getResources().getString(R.string.chef)))
                    stOcc = "chef";
                if (values[i].equals(getResources().getString(R.string.cleaner)))
                    stOcc = "cleaner";
                if (values[i].equals(getResources().getString(R.string.doctor)))
                    stOcc = "doctor";
                if (values[i].equals(getResources().getString(R.string.farmer)))
                    stOcc = "farmer";
                if (values[i].equals(getResources().getString(R.string.lawyer)))
                    stOcc = "lawyer";
                if (values[i].equals(getResources().getString(R.string.painter)))
                    stOcc = "painter";
                if (values[i].equals(getResources().getString(R.string.programmer)))
                    stOcc = "programmer";
                if (values[i].equals(getResources().getString(R.string.scientist)))
                    stOcc = "scientist";
                if (values[i].equals(getResources().getString(R.string.soldier)))
                    stOcc = "soldier";
                if (values[i].equals(getResources().getString(R.string.vet)))
                    stOcc = "vet";
