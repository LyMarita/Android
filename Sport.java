...
public class Sport extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
public static String st;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] values=new String[]{getResources().getString(R.string.archery),getResources().getString(R.string.basketball),
                getResources().getString(R.string.baseball), getResources().getString(R.string.bowling),getResources().getString(R.string.football),
                getResources().getString(R.string.golf),getResources().getString(R.string.horse_racing),
                getResources().getString(R.string.tennis),getResources().getString(R.string.volleyball),
                getResources().getString(R.string.weightlifting)};
        Class_Sport listFamily=new Class_Sport(this,values);
        lst.setAdapter(listFamily);
        lst.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                //Toast.makeText(Sport.this, values[i], Toast.LENGTH_LONG).show();
                if (values[i].equals(getResources().getString(R.string.archery)))
                    st = "archery";
                if (values[i].equals(getResources().getString(R.string.basketball)))
                    st = "basketball";
                if (values[i].equals(getResources().getString(R.string.baseball)))
                    st = "baseball";
                if (values[i].equals(getResources().getString(R.string.bowling)))
                    st = "bowling";
                if (values[i].equals(getResources().getString(R.string.football)))
                    st = "football";
                if (values[i].equals(getResources().getString(R.string.golf)))
                    st = "golf";
                if (values[i].equals(getResources().getString(R.string.horse_racing)))
                    st = "horse_racing";
                if (values[i].equals(getResources().getString(R.string.tennis)))
                    st = "tennis";
                if (values[i].equals(getResources().getString(R.string.volleyball)))
                    st = "volleyball";
                if (values[i].equals(getResources().getString(R.string.weightlifting)))
                    st = "weightlifting";
